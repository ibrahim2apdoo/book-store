                            ...
                            <td class="text-center">
                                <div class="quote text-center mt-1">
                                    ...
                                    <input type="number" name="quantity" value="{{ $item->quantity }}"
                                           class="w-6 text-center bg-gray-300" min="1" max="{{$product->first()->product_quantity}}"/>
                                </div>
                                ...
                                <li>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="flat-rate" name="shipping" class="custom-control-input"
                                               checked="">
                                        <label class="custom-control-label" for="flat-rate">Flat Rate : ${{ Cart::getTotal() }}</label>
                                    </div>
                                </li>
                                <li>
                                    <div class="custom-control custom-radio">
