                ...
                <div class="row product-list product-detail">
                    <div class="col-12 col-lg-5 product-detail-slider">
                        <div class="imageProduct">
                            <img src="<?php echo e(asset('storage/'.$product->product_image)); ?>" alt="Los Angeles" width="470" height="470">
                        </div>
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="product-single">
                            <div class="product-single-price">
                                <h4><span class="real-price">$<?php echo e($product->product_price); ?></span> <span><del>$<?php echo e($product->product_price + 100); ?></del></span></h4>
                            ...
                            <div class="product-quantity input_plus_mins no-gutters">
                                ...
                                <div class="qty col-12 col-lg-3 d-lg-flex  align-items-lg-center d-inline-block">
                                    <div class="quantity">
                                        ...
                                        <input type="number" class="count qty " name="quantity" value="<?php echo e($product->product_quantity); ?>" disabled="">
...
<?php /**PATH C:\Users\pc\Desktop\book-store-master\book-store\resources\views/website/show_product_details.blade.php ENDPATH**/ ?>