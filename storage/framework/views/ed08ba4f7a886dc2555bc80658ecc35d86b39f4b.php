...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/design/adminlte/plugins/datatables/jquery.dataTables.js">
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/design/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
...
<div class="wrapper">
<?php /**PATH C:\Users\Apdoo\Desktop\New folder\book-store\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>