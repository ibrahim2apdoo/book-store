                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($categoryinfo->category_image)): ?>
                                            <img src="<?php echo e(Storage::url($categoryinfo->category_image)); ?>" style="width: 100px;height: 100px;">
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            </tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($productinfo->product_image)): ?>
                                            <img src="<?php echo e(Storage::url($productinfo->product_image)); ?>" style="width: 100px;height: 100px;">
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\book-store-master\resources\views/category/show.blade.php ENDPATH**/ ?>