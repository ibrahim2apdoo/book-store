        ...
        <div class="box-body ">
            ...
            <div class="form-group ">
                <?php if(!empty($category->category_image)): ?>
                    <img src="<?php echo e(Storage::url( $category->category_image)); ?>" style="width: 50px;height: 50px;">
                <?php endif; ?>
                <div class="row">
                    <div class="col-lg-12">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\book-store-master\resources\views/category/edit.blade.php ENDPATH**/ ?>