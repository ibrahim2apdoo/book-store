        ...
        <div class="box-body ">
            ...
            <div class="form-group ">
                <?php if(!empty($product->product_image)): ?>
                    <img src="<?php echo e(Storage::url($product->product_image)); ?>" style="width: 50px;height: 50px;">
                <?php endif; ?>
                <div class="row">
                    <div class="col-lg-12">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Desktop\book-store-master\resources\views/product/edit.blade.php ENDPATH**/ ?>